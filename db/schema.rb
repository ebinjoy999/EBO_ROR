...
ActiveRecord::Schema.define(version: 20150725140859) do
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string   "emloyee_ID",             limit: 255
    t.string   "dob",                    limit: 255
    t.string   "gender",                 limit: 255
    t.string   "time_zone",              limit: 255
    t.string   "doj",                    limit: 255
    t.string   "educational_detail",     limit: 255
    t.string   "comments",               limit: 255
    t.string   "lock",                   limit: 255
    t.string   "active",                 limit: 255
    t.string   "deactive_date",          limit: 255
    t.string   "deactive_reason",        limit: 255
